...
if __name__ == "__main__":
    ...
    argparser.add_argument("--dropout", type=float, default=0.22, help="dropout level; 0.0 means no dropout")
    argparser.add_argument("--backbone_noise", type=float, default=0, help="amount of noise added to backbone during training")   
